...
//       type: product.type,
//       fragranceNotes: {
//         topNotes: product.fragranceNotes?.topNotes || "",
//         middleNotes: product.fragranceNotes?.middleNotes || "",
//         baseNotes: product.fragranceNotes?.baseNotes || "",
//       },
//       images: [], 
//     });
...
//     if (e.target.files) {
//       const newFiles = Array.from(e.target.files).slice(0, 5 - form.images.length);
//       setForm((prev) => ({
//         ...prev,
...
//         ...form,
//         images: undefined, // Exclude files from JSON
//       }));
//       form.images.forEach((file, i) => formData.append(`image${i}`, file));
...
//         <img
//           src={product.images[0].url} // use .url here
...
//     </div>
//     <div>
//       <p className="font-medium">{product.brand?.name || product.brandId}</p>
//       <p className="text-sm text-muted-foreground">{product.flavor}</p>
//     </div>
//   </div>
// </TableCell>
//                       <TableCell>{getCategoryLabel(product.category)}</TableCell>
//                       <TableCell>{formatPrice(product.mrp.toString())}</TableCell>
...
//             <div>
//               <label className="text-sm font-medium block mb-1">Flavor Profile *</label>
//               <Input
//                 value={form.flavor}
...
export default function ProductsTab() {
  ...
  const handleEdit = (product: Product) => {
    setForm({
      ...
      images: [], // Will be updated with new uploads
    });
    setImagePreviews(product.images.map((img) => img.url)); // Use existing image URLs
    setEditingProduct(product);
    setOpen(true);
  };
